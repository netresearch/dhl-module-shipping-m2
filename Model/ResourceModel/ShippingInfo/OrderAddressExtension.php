...
/**
 * Resource Model for DHL Shipping Order Address Extension
 *
 * @category Dhl
 * @package  Dhl\Shipping
 * @author   Benjamin Heuer <benjamin.heuer@netresearch.de>
 ...
 * @link     http://www.netresearch.de/
 */
class OrderAddressExtension extends AbstractDb
{
    /**
     * @var EntityManager
     */
    ...
    /**
     * OrderAddressExtension constructor.
    ...
    {
        $this->_init(ShippingSetup::TABLE_ORDER_ADDRESS, AbstractAddressExtension::ADDRESS_ID);
    }
