...
/**
 * ChangePackagingGridTemplateObserver
 *
 * @category Dhl
 * @package  Dhl\Shipping
 * @author   Sebastian Ertner <sebastian.ertner@netresearch.de>
 ...
 * @link     http://www.netresearch.de/
 */
class ChangePackagingGridTemplateObserver implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($block instanceof \Magento\Shipping\Block\Adminhtml\Order\Packaging\Grid) {
            ...
            if ($shippingMethod->getData('carrier_code') === Carrier::CODE
                ...
                $block->setTemplate('Dhl_Shipping::order/packaging/grid.phtml');
            }
        }
    }
}
